...
st.markdown('<style>body{background-color: #36c102;}</style>', unsafe_allow_html=True)
image = Image.open('bamx-logo.jpeg')
...
html_title = """
    ...
    <center>
        <h1 class="title-test">Food wastage | AI Powered</h1>
    </center>"""
with col2:
